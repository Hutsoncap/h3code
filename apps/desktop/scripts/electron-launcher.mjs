// This file mostly exists because we want dev mode to say "H3 Code (Dev)" instead of "electron"
...
const MICROPHONE_USAGE_DESCRIPTION =
  "H3 Code needs microphone access so you can record voice notes and transcribe them into the chat composer.";
