...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  },
  {
    ...
    group: "app",
    label: "Browser",
    description: "Search defaults, homepage behavior, and browsing data.",
    icon: GlobeIcon,
    eyebrow: "Web surfaces",
  },
  {
    id: "worktrees",
    group: "app",
    label: "Worktrees",
    description: "Review and clean up the worktrees created by H3 Code.",
    icon: WorktreeIcon,
