...
| **p0.6** | Unify process/session abstraction                 | [.plans/10-unify-process-session-abstraction.md](.plans/10-unify-process-session-abstraction.md) | 🚧 worktree: h3code-p0.6-process-session-abstraction |
