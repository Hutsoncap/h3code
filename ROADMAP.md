...
| **hX40** | Provider session directory hardening — add focused coverage for state-dir resolution, provider name normalization, and deterministic fallback session paths                                                                   | 🚧 worktree: h3code-hx40-provider-session-directory                                                                                                                                                                                                                     |
