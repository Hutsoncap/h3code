...
| **hX21** | WebSocket push-bus send isolation — keep per-recipient `client.send` failures from aborting later recipients or poisoning later queued jobs                                                      | 🚧 Claimed in `codex/hx21-pushbus-send-isolation`                                                                                                                                                                                                                       |
