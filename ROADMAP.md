...
| **hX25** | Project contract coverage for search and write payloads — exercise `packages/contracts/src/project.ts` so malformed project search/write inputs and results fail before runtime code depends on them      | 🚧 worktree: codex/hx25-project-contract-coverage                                                                                                                                                                                                                       |
