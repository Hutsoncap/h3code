...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 #17/#19/#20/#24/#30/#32/#34/#36/#38/#42 — composer, body, thread, empty-state, image-dialog, dialogs, shell, footer, active-plan-card, status-banner, and pull-request-dialog panes extracted; more ChatView seams remain |
...
| **hX16** | Voice transcription websocket boundary validation — reject malformed transcribe requests early and normalize unsupported-provider/runtime plus adapter-failure cases at the ws/native edge       | 🚧 worktree: `codex/hx16-transcribe-voice-validation`                                                                                                                                                                                                                   |
