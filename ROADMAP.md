...
| ID        | Title                                                                                    | Status                                                                                                                                                                                                                                                                  |
| --------- | ---------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v1a**   | Sidebar unify + theme catalog                                                            | 🚧 draft PR [#226](https://github.com/Hutsoncap/h3code/pull/226) — worktree: `/Users/hutson/Code/h3code.worktrees/h3code-v1a-sidebar-themes` (`feat/v1a-sidebar-themes`); local `bun fmt`, `bun lint`, `bun typecheck`, and `bun run test` are green; CI is in progress |
...
Live lane: draft PR [#226](https://github.com/Hutsoncap/h3code/pull/226). The sidebar-unify half of `v1a` is implemented and locally verified; GitHub CI is currently running on the first published head.
