...
| **hX29** | Shell IPC boundary hardening — extract desktop shell handlers and tighten blank-input contract coverage so external-open and show-in-folder calls fail before runtime side effects                        | 🚧 worktree: codex/hx29-shell-ipc-hardening                                                                                                                                                                                                                             |
