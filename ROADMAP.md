...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 merged slices: [#196](https://github.com/Hutsoncap/h3code/pull/196) + [#197](https://github.com/Hutsoncap/h3code/pull/197) + [#198](https://github.com/Hutsoncap/h3code/pull/198) + [#199](https://github.com/Hutsoncap/h3code/pull/199) + [#200](https://github.com/Hutsoncap/h3code/pull/200) + [#201](https://github.com/Hutsoncap/h3code/pull/201) + [#202](https://github.com/Hutsoncap/h3code/pull/202) + [#203](https://github.com/Hutsoncap/h3code/pull/203) + [#204](https://github.com/Hutsoncap/h3code/pull/204) + [#205](https://github.com/Hutsoncap/h3code/pull/205) + [#206](https://github.com/Hutsoncap/h3code/pull/206) + [#207](https://github.com/Hutsoncap/h3code/pull/207) + [#208](https://github.com/Hutsoncap/h3code/pull/208) + [#209](https://github.com/Hutsoncap/h3code/pull/209) + [#210](https://github.com/Hutsoncap/h3code/pull/210) + [#211](https://github.com/Hutsoncap/h3code/pull/211) + [#212](https://github.com/Hutsoncap/h3code/pull/212) + [#213](https://github.com/Hutsoncap/h3code/pull/213) + [#214](https://github.com/Hutsoncap/h3code/pull/214) — thread-scoped terminal state/store wiring, composer voice lifecycle, runtime/interaction-mode plus persisted thread-settings bindings, the environment-mode binding, the provider-model / traits / fast-mode extraction, the project-script launch + CRUD bindings, the terminal visibility / close-delete flow, the pending approval / user-input response bindings, the queued-turn / implementation-thread launch bindings, the turn-start / interrupt / local-dispatch seam, the composer command-menu / slash-command / prompt-edit seam, the composer paste / drag-drop attachment seam, the inline terminal-context placeholder seam, the transcript/navigation callback seam, the composer plan/status/menu/footer render seam, the remaining ChatView shell prop assembly / auxiliary shell node extraction, the transcript/composer pane prop assembly, the dialog / expanded-image prop assembly, and the queued-turn restore plus live composer send / dispatch controller block all now live on `main`; live lane: `/Users/hutson/Code/h3code-p0.3-chatview-terminal-shortcut-bindings` (`codex/p0.3-chatview-terminal-shortcut-bindings`) / draft PR [#215](https://github.com/Hutsoncap/h3code/pull/215) against `main` — the terminal-open / workspace-focus / desktop-menu / global-shortcut controller now lives in [`apps/web/src/components/chat/useChatTerminalShortcutBindings.ts`](apps/web/src/components/chat/useChatTerminalShortcutBindings.ts); local `bun fmt`, `bun lint`, and `bun typecheck` are green, and [`apps/web/src/components/ChatView.tsx`](apps/web/src/components/ChatView.tsx) is down to 3,211 lines on this branch |
