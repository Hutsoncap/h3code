...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 worktree: h3code-p0.3-split-chatview-next-slice — chat body/layout extraction |
...
| **hX6** | IPC schema validation at every boundary — make `packages/contracts` the only source of truth; reject unknown fields in dev                                                                                                              | 🚧 worktree: h3code-hx6-ipc-schema-validation (first slice: desktop voice transcription IPC) |
