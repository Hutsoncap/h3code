...
| **hX26** | Provider discovery contract coverage — exercise `packages/contracts/src/providerDiscovery.ts` so malformed discovery payloads fail before runtime code depends on them                                    | 🚧 worktree: codex/hx26-provider-discovery-contract-coverage                                                                                                                                                                                                            |
