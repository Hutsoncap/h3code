...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 #17 — composer pane extracted; more ChatView seams remain |
...
| ID      | Title                                                                                                                                                                                            | Status                                              |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------- |
| **hX1** | Persisted-state migration test harness — every live web zustand/persist store gets an explicit legacy `t3code:` to `h3code:` key migration test covering the current on-disk shape               | 🚧 worktree: h3code-hx1-persisted-migration-harness |
