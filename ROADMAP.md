...
| **hX31** | Base schema contract coverage — exercise shared trimmed-string, integer, and branded-id schemas so malformed base payloads fail before higher-level contracts depend on them                              | 🚧 worktree: codex/hx31-base-schema-contract-coverage                                                                                                                                                                                                                   |
