...
| **hX6**  | IPC schema validation at every boundary — make `packages/contracts` the only source of truth; reject unknown fields in dev                                                                       | 🚧 worktree: codex/hx6-notification-payload-hardening — #18/#22/#29/#31 — voice transcription, notifications, editor, and shell bridge IPC validated; more boundaries remain |
