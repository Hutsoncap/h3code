...
| **hX27** | Thread workspace normalization coverage — exercise shared workspace-root normalization and associated worktree precedence so thread workspace metadata stays deterministic                                | 🚧 worktree: codex/hx27-thread-workspace-coverage                                                                                                                                                                                                                       |
