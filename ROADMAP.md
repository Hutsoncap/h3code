...
| **hX6**  | IPC schema validation at every boundary — make `packages/contracts` the only source of truth; reject unknown fields in dev                                                                       | 🚧 worktree: codex/hx6-confirm-message-validation — #18/#22/#29/#31/#33/#35 — voice transcription, notifications, editor, shell bridge, notification payload, and menu action IPC validated; confirm-message boundary in progress |
