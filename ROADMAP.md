...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 merged slices: [#196](https://github.com/Hutsoncap/h3code/pull/196) + [#197](https://github.com/Hutsoncap/h3code/pull/197) + [#198](https://github.com/Hutsoncap/h3code/pull/198) + [#199](https://github.com/Hutsoncap/h3code/pull/199) + [#200](https://github.com/Hutsoncap/h3code/pull/200) + [#201](https://github.com/Hutsoncap/h3code/pull/201) + [#202](https://github.com/Hutsoncap/h3code/pull/202) — thread-scoped terminal state/store wiring, composer voice lifecycle, runtime/interaction-mode plus persisted thread-settings bindings, the environment-mode binding, the provider-model / traits / fast-mode extraction, the project-script launch + CRUD bindings, and the terminal visibility / close-delete flow all now live on `main`; live lane: `/Users/hutson/Code/h3code-p0.3-chatview-pending-user-input-bindings` (`codex/p0.3-chatview-pending-user-input-bindings`) / draft PR [#203](https://github.com/Hutsoncap/h3code/pull/203) against `main` — the pending approval / pending user-input response, answer-mutation, and question-navigation bindings now live in `useChatPendingInteractionBindings`, local `bun fmt`, `bun lint`, and `bun typecheck` are green, CI is fully green, and [apps/web/src/components/ChatView.tsx](apps/web/src/components/ChatView.tsx) is down to 5,052 lines on the live branch, so this slice is merge-ready while Phase 1 remains blocked until more seams land |
