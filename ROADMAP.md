...
| **hX28** | Server attachment-path boundary hardening — add direct unit coverage for attachment-relative path normalization and resolution so path traversal and malformed attachment URLs stay rejected predictably  | 🚧 worktree: codex/hx28-attachment-path-boundary                                                                                                                                                                                                                        |
