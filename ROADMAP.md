...
| **hX2** | WebSocket reconnect / session recovery test suite — simulate server restart, partial stream, network flap; verify thread state, browser tabs, and terminal runtimes recover predictably                                                 | 🚧 worktree: h3code-hx2-session-recovery |
