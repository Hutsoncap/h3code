...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 merged slices: [#196](https://github.com/Hutsoncap/h3code/pull/196) + [#197](https://github.com/Hutsoncap/h3code/pull/197) + [#198](https://github.com/Hutsoncap/h3code/pull/198) + [#199](https://github.com/Hutsoncap/h3code/pull/199) + [#200](https://github.com/Hutsoncap/h3code/pull/200) + [#201](https://github.com/Hutsoncap/h3code/pull/201) + [#202](https://github.com/Hutsoncap/h3code/pull/202) + [#203](https://github.com/Hutsoncap/h3code/pull/203) — thread-scoped terminal state/store wiring, composer voice lifecycle, runtime/interaction-mode plus persisted thread-settings bindings, the environment-mode binding, the provider-model / traits / fast-mode extraction, the project-script launch + CRUD bindings, the terminal visibility / close-delete flow, and the pending approval / user-input response bindings all now live on `main`; live lane: `/Users/hutson/Code/h3code-p0.3-chatview-queued-turn-bindings` (`codex/p0.3-chatview-queued-turn-bindings`) / draft PR [#204](https://github.com/Hutsoncap/h3code/pull/204) against `main` — queued-turn dispatch, plan-follow-up submission, and implementation-thread launch bindings now live in `useChatQueuedTurnBindings`, local `bun fmt`, `bun lint`, and `bun typecheck` are green, PR metadata plus `Format + Lint`, `Browser Test`, `Build Desktop Pipeline`, `Release Smoke`, and `Typecheck` are green, and the only red check is `Test`, failing in `apps/server/src/git/Layers/CodexTextGeneration.test.ts` when the live branch-name generation test receives invalid structured output from Codex; [apps/web/src/components/ChatView.tsx](apps/web/src/components/ChatView.tsx) is down to 4,780 lines on the live branch versus 5,052 on `main`, so Phase 1 remains blocked until more seams land |
...
| **p0.1** | Typed IPC boundaries                              | [.plans/02-typed-ipc-boundaries.md](.plans/02-typed-ipc-boundaries.md)                           | ✅ #7 — desktop IPC payloads validated                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **p0.2** | Zod (or Effect/Schema) persisted-state validation | [.plans/05-zod-persisted-state-validation.md](.plans/05-zod-persisted-state-validation.md)       | ✅ #9 — persisted-state hydration validated                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 merged slices: [#196](https://github.com/Hutsoncap/h3code/pull/196) + [#197](https://github.com/Hutsoncap/h3code/pull/197) — thread-scoped terminal state/store wiring now lives in `useChatTerminalBindings`, and the composer voice lifecycle now lives in `useComposerVoiceController` on `main`; live lane: `/Users/hutson/Code/h3code-p0.3-chatview-thread-settings-bindings` (`codex/p0.3-chatview-thread-settings-bindings`) / draft PR [#198](https://github.com/Hutsoncap/h3code/pull/198) against `main` — CI is running for the runtime/interaction-mode and persisted thread-settings extraction; stacked lane: `/Users/hutson/Code/h3code-p0.3-chatview-env-mode-bindings` (`codex/p0.3-chatview-env-mode-bindings`) / draft PR [#199](https://github.com/Hutsoncap/h3code/pull/199) against `#198` — CI has started for the environment-mode binding extraction around `onEnvModeChange`, and [apps/web/src/components/ChatView.tsx](apps/web/src/components/ChatView.tsx) is down to ~5.6k lines on the stacked branch, so Phase 1 remains blocked until more seams land                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **p0.4** | Split codexAppServerManager.ts                    | [.plans/03-split-codex-app-server-manager.md](.plans/03-split-codex-app-server-manager.md)       | ✅ #13 — codex app-server helpers split                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **p0.5** | Event-state test expansion                        | [.plans/09-event-state-test-expansion.md](.plans/09-event-state-test-expansion.md)               | ✅ #4 — store event-state coverage expanded                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **p0.6** | Unify process/session abstraction                 | [.plans/10-unify-process-session-abstraction.md](.plans/10-unify-process-session-abstraction.md) | ✅ #10 — terminal runtime/session handles unified                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **p0.7** | CI quality gates                                  | [.plans/07-ci-quality-gates.md](.plans/07-ci-quality-gates.md)                                   | ✅ #3 — CI actually runs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
