...
| **hX6**  | IPC schema validation at every boundary — make `packages/contracts` the only source of truth; reject unknown fields in dev                                                                       | 🚧 worktree: codex/hx6-update-ipc-contracts — #18/#22/#29/#31/#33/#35/#37 — voice transcription, notifications, editor, shell bridge, notification payload, menu action, and confirm-message IPC validated; desktop update IPC boundary in progress |
