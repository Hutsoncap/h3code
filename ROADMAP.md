...
| **hX36** | Shared schema JSON utility coverage — exercise `packages/shared/src/schemaJson.ts` decode helpers and formatter paths so valid decodes plus malformed JSON and shape failures stay predictable            | 🚧 worktree: h3code-hx36-schema-json-coverage                                                                                                                                                                                                                           |
