...
| **hX17** | Renderer project.writeFile request validation — decode workspace write payloads before crossing the websocket bridge                                                                             | 🚧 worktree: hx17-wsnativeapi-boundary — workspace write-file payload validation added                                                                                                                                                                                  |
