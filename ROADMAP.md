...
| **hX30** | Model contract coverage — exercise provider-specific model option schemas and alias/default invariants so malformed model payloads fail before runtime code depends on them                               | 🚧 worktree: codex/hx30-model-contract-coverage                                                                                                                                                                                                                         |
