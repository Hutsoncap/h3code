...
| **hX38** | Shared terminal thread identity coverage — exercise command normalization, incremental input/control handling, sticky provider reconciliation, and fallback visual identity defaults so terminal metadata stays deterministic | 🚧 worktree: h3code-hx38-terminal-threads-coverage                                                                                                                                                                                                                      |
