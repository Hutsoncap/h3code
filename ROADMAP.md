...
| **hX6**  | IPC schema validation at every boundary — make `packages/contracts` the only source of truth; reject unknown fields in dev                                                                       | 🚧 #18/#22/#29/#31/#33/#35/#37/#39 — voice transcription, notifications, editor, shell bridge, notification payload, menu action, confirm-message, and desktop update IPC validated; more boundaries remain |
...
| **hX13** | WebSocket push-bus delivery semantics — cover targeted isolation, closed-client skips, and sequence continuity so server pushes remain predictable under reconnect churn                         | 🚧 worktree: `codex/hx13-push-bus-hardening`                                                                                                                                                                |
