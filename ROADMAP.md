...
| **hX34** | Codex CLI version-gating hardening — lock down version parsing, comparison, and upgrade messaging so startup rejects unsupported Codex CLI versions predictably, including prerelease and shortened forms | 🚧 worktree: codex/server-codex-cli-version-hardening                                                                                                                                                                                                                   |
