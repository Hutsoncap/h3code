...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 worktree: `/Users/hutson/Code/h3code` (`codex/p0.3-chatview-terminal-state-bindings`) — #17/#19/#20/#24/#30/#32/#34/#36/#38/#42/#50/#195 extracted many UI seams, most recently composer-draft/store bindings in [#195](https://github.com/Hutsoncap/h3code/pull/195); the current slice is resuming `p0.3` by targeting terminal-state/store wiring in [apps/web/src/components/ChatView.tsx](apps/web/src/components/ChatView.tsx), which is still ~6.1k lines on `main`, so Phase 1 remains blocked until more seams land |
