...
| **hX6**  | IPC schema validation at every boundary — make `packages/contracts` the only source of truth; reject unknown fields in dev                                                                       | 🚧 #18/#22/#29/#31/#33 — voice transcription, notifications, editor, shell bridge, and notification payload IPC validated; more boundaries remain |
