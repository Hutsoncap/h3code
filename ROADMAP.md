...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 worktree: codex/p0.3-chatview-overlays-2 — #17/#19/#20/#24/#30 — composer, body, thread, empty-state, image-dialog, and dialogs panes extracted; more ChatView seams remain |
...
| **hX6** | IPC schema validation at every boundary — make `packages/contracts` the only source of truth; reject unknown fields in dev | 🚧 #18/#22/#29/#31 — voice transcription, notifications, editor, and shell bridge IPC validated; more boundaries remain |
