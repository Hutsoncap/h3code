...
| **p0.4** | Split codexAppServerManager.ts                    | [.plans/03-split-codex-app-server-manager.md](.plans/03-split-codex-app-server-manager.md)       | 🚧 worktree: h3code-p0.4-codex-app-server-manager |
