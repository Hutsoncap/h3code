...
| **p0.3** | Split ChatView.tsx                                | [.plans/04-split-chatview-component.md](.plans/04-split-chatview-component.md)                   | 🚧 #17/#19/#20/#24/#30/#32/#34/#36/#38 — composer, body, thread, empty-state, image-dialog, dialogs, shell, footer, active-plan-card, and status-banner panes extracted; more ChatView seams remain |
...
- 🚧 worktree: `codex/p0.3-chatview-status-banner` — composer status banner selector extracted; more ChatView seams remain
...
| **hX6**  | IPC schema validation at every boundary — make `packages/contracts` the only source of truth; reject unknown fields in dev                                                                       | 🚧 #18/#22/#29/#31/#33/#35 — voice transcription, notifications, editor, shell bridge, notification payload, and menu action IPC validated; more boundaries remain |
